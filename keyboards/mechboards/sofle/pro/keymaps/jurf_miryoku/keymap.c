...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [U_GAME] = LAYOUT(
        ...
        KC_B,              KC_LSFT,           KC_Z,              KC_X,              KC_C,              KC_V,              KC_MPLY,           KC_MUTE,           KC_N,              KC_M,              KC_COMM,           KC_DOT,            KC_SLSH,              KC_EQL,
    ...
    [U_BASE] = LAYOUT(
        ...
        KC_LSFT,           LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      LT(U_GAME,KC_C),   LT(U_GAME,KC_D),   LT(U_GAME,KC_V),   KC_MPLY,           KC_MUTE,           KC_K,              KC_H,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_SLSH), KC_RSFT,
    ...
    [U_EXTRA] = LAYOUT(
        ...
        KC_LSFT,           LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_MPLY,           KC_MUTE,           KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_SLSH), KC_RSFT,
                                              GUI_T(KC_RIGHT),   ALT_T(KC_RIGHT),   LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  KC_LEFT,           KC_RIGHT
    ),
    [U_TAP] = LAYOUT(
        ...
        KC_LSFT,           KC_Z,              KC_X,              KC_C,              KC_D,              KC_V,              KC_MPLY,           KC_MUTE,           KC_K,              KC_H,              KC_COMM,           KC_DOT,            KC_SLSH,              KC_RSFT,
                                              GUI_T(KC_RIGHT),   ALT_T(KC_RIGHT),   LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  KC_LEFT,           KC_RIGHT
    ),
    [U_1HAND] = LAYOUT(
        ...
        KC_LSFT,           LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      LT(U_GAME,KC_C),   LT(U_GAME,KC_V),   LT(U_GAME,KC_B),   KC_MPLY,           KC_MUTE,           KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_SLSH), KC_RBRC,
    ...
    [U_NAV] = LAYOUT(
        ...
        _______,           U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    U_NA,              _______,           _______,           KC_INS,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,               _______,
                                              U_NP,              U_NP,              U_NA,              KC_NO,             U_NA,              KC_ENT,            KC_BSPC,           KC_DEL,            U_NP,              U_NP
    ),
    [U_MOUSE] = LAYOUT(
        _______,           _______,           _______,           _______,           _______,           _______,                                                 _______,           _______,           _______,           _______,           _______,              _______,
        _______,           TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   TD(U_TD_U_GAME),                                         U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,                _______,
        ...
        _______,           U_NA,              KC_ALGR,           TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  U_NA,              _______,           _______,           KC_WWW_BACK,       MS_WHLL,           MS_WHLD,           MS_WHLU,           MS_WHLR,              _______,
                                              U_NP,              U_NP,              U_NA,              U_NA,              KC_NO,             MS_BTN2,           MS_BTN1,           MS_BTN3,           U_NP,              U_NP
    ),
    [U_MEDIA] = LAYOUT(
        _______,           _______,           _______,           _______,           _______,           _______,                                                 _______,           _______,           _______,           _______,           _______,              _______,
        _______,           TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   TD(U_TD_U_GAME),                                         RM_TOGG,           RM_NEXT,           RM_HUEU,           RM_SATU,           RM_VALU,              _______,
        _______,           KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,                                                    U_NU,              KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,              _______,
        _______,           U_NA,              KC_ALGR,           TD(U_TD_U_FUN),    TD(U_TD_U_MEDIA),  U_NA,              _______,           _______,           _______,           U_NU,              U_NU,              U_NU,              U_NU,                 _______,
                                              U_NP,              U_NP,              KC_NO,             U_NA,              U_NA,              KC_MSTP,           KC_MPLY,           KC_MUTE,           U_NP,              U_NP
    ),
    [U_NUM] = LAYOUT(
        _______,           _______,           _______,           _______,           _______,           _______,                                                 _______,           _______,           _______,           _______,           _______,              _______,
        ...
        KC_NO,             KC_GRV,            KC_1,              KC_2,              KC_3,              KC_BSLS,           _______,           _______,           U_NA,              TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    KC_ALGR,           U_NA,                 _______,
                                              _______,           KC_0,              KC_DOT,            KC_0,              KC_NO,             U_NA,              KC_NO,             U_NA,              U_NP,              U_NP
    ),
    [U_SYM] = LAYOUT(
        _______,           _______,           _______,           _______,           _______,           _______,                                                 _______,           _______,           _______,           _______,           _______,              _______,
        ...
        _______,           KC_TILD,           KC_EXLM,           KC_AT,             KC_HASH,           KC_PIPE,           _______,           _______,           U_NA,              TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  KC_ALGR,           U_NA,                 _______,
                                              _______,           KC_RPRN,           KC_LPRN,           KC_RPRN,           KC_NO,             KC_NO,             U_NA,              U_NA,              U_NP,              U_NP
    ),
    [U_FUN] = LAYOUT(
        _______,           _______,           _______,           _______,           _______,           _______,                                                 _______,           _______,           _______,           _______,           _______,              _______,
        ...
        _______,           KC_F10,            KC_F1,             KC_F2,             KC_F3,             KC_PAUS,           _______,           _______,           U_NA,              TD(U_TD_U_FUN),    TD(U_TD_U_MEDIA),  KC_ALGR,           U_NA,                 _______,
                                              KC_APP,            KC_ESC,            KC_ESC,            KC_SPC,            KC_TAB,            U_NA,              U_NA,              KC_NO,             U_NP,              U_NP
    ),
    // clang-format on
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [U_GAME]   = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT)},
    [U_BASE]   = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT)},
    [U_EXTRA]  = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT)},
    [U_TAP]    = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT)},
    [U_1HAND]  = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_MPRV, KC_MNXT)},
